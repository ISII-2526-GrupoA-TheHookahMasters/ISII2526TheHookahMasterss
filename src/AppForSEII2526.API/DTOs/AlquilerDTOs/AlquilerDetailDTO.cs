namespace AppForSEII2526.API.DTOs.AlquilerDTOs
{
    public class AlquilerDetailDTO
    {
        ...
        public AlquilerDetailDTO(int id, string nombreCliente, string apellidosCliente, string direccionEnvio, DateTime fechaAlquiler, float precioTotal, DateTime fechaFin, DateTime fechaInicio, IList<AlquilarItemDTO> alquilerItems)
        {
            Id = id;
